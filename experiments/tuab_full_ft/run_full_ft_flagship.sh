...
# Paths
OUTPUT_DIR="experiments/tuab_full_ft/results_flagship_gradient"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Experiment (FLAGSHIP) ===" | tee -a "$LOG_FILE"
...
python experiments/tuab_full_ft/run_full_ft_compare.py \
    ...
    --device cuda \
    --ratios 0.005 0.01 0.05 0.1 0.2 0.5 1.0 \
