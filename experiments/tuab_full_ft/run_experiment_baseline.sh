...
# Hyperparameters
BATCH_SIZE=128 # 64 per GPU * 4 GPUs
LEARNING_RATE=1e-4
EPOCHS=10
NUM_WORKERS=16

# Paths
OUTPUT_DIR="experiments/tuab_full_ft/results_baseline_gradient"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Baseline Experiment (TUAB) ===" | tee -a "$LOG_FILE"
