...
LEARNING_RATE=1e-4 # Scaled linearly
EPOCHS=20
NUM_WORKERS=16 # Reduced from 16 to save RAM

# Paths
OUTPUT_DIR="experiments/tuev_full_ft/results_baseline_seed6"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Baseline Experiment (TUEV) ===" | tee -a "$LOG_FILE"
