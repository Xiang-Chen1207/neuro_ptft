...
# Paths
OUTPUT_DIR="experiments/tuep_full_ft/results_flagshipfinal"
CONFIG="configs/finetune_tuep.yaml"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Experiment (FLAGSHIP - TUEP) ===" | tee -a "$LOG_FILE"
echo "Timestamp: $(date)" | tee -a "$LOG_FILE"
echo "Output Directory: $OUTPUT_DIR" | tee -a "$LOG_FILE"

export CUDA_VISIBLE_DEVICES="$GPU_IDS"

python experiments/tuep_full_ft/run_full_ft_compare.py \
    --config "$CONFIG" \
