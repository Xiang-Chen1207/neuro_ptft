...
# Paths
OUTPUT_DIR="experiments/tuep_full_ft/results_baseline"
CONFIG="configs/finetune_tuep.yaml"
DATASET_DIR="/vePFS-0x0d/home/cx/ptft/tuep"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Baseline Experiment (TUEP) ===" | tee -a "$LOG_FILE"
