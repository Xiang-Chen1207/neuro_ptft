...
# Paths
OUTPUT_DIR="experiments/seed_ft/results_flagship"
CONFIG="configs/finetune_seed.yaml"
...
# === Execution ===
echo "=== Starting Full Fine-tuning Experiment (FLAGSHIP - SEED) ===" | tee -a "$LOG_FILE"
echo "Timestamp: $(date)" | tee -a "$LOG_FILE"
echo "Output Directory: $OUTPUT_DIR" | tee -a "$LOG_FILE"

export CUDA_VISIBLE_DEVICES="$GPU_IDS"

python experiments/seed_ft/run_full_ft_compare.py \
    --config "$CONFIG" \
